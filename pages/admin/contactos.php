<?php
// filepath: c:\xampp\htdocs\CodeCraft\pages\admin\contactos.php
...
// Consulta todos los mensajes de contacto
...
<head>
  <meta charset="UTF-8">
  <title>Mensajes de Contacto | Admin CodeCraft</title>
...
<body>
  <div class="container">
    ...
    <table>
      ...
      <?php else: ?>
        <tr>
          <td colspan="6" style="text-align:center;">No hay mensajes registrados.</td>
        </tr>
      <?php endif; ?>
    </table>
